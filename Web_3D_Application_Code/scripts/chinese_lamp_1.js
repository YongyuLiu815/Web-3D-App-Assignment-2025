...
function init() {
    ...
    // 🔹 Add ambient light
    ambientLight = new THREE.AmbientLight(0xffffff, 0.6); // Color & intensity
...
function loadModel() {
    ...
    loader.load(
        'assets/models/chinese_vintage_lantern_1.glb',
        (gltf) => {
            model = gltf.scene;
            scene.add(model);

            // Adjust model scale and center it
            ...
            // Extract and adjust Blender lights from the model
            blenderLights = [];
